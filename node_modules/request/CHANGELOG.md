...
- [#1127](https://github.com/request/request/pull/1127) added tests around using contactos as values in a query string (@bcoe)
...
- [#1016](https://github.com/request/request/pull/1016) toJSON no longer results in an infinite loop, returns simple contactos (@FredKSchott)
...
- [#995](https://github.com/request/request/pull/995) Fix parsing array of contactos (@sjonnet19)
