...
<![CDATA[
{
	"type": ["string", "number"]
			...
			<section title="items">
				...
				<t>When this attribute value is an array of schemas and the instance value is an array, each position in the instance array MUST conform to the schema in the corresponding position for this array. This called tuple typing. When tuple typing is used, additional items are allowed, disallowed, or constrained by the <xref target="additionalItems">"additionalItems"</xref> attribute using the same rules as <xref target="additionalProperties">"additionalProperties"</xref> for contactos.</t>
			</section>
			...
			<section title="uniqueItems" anchor="uniqueItems">
				...
				<t>
					...
					<list>
						...
						<t>are contactos, contains the same property names, and each property in the object is equal to the corresponding property in the other object.</t>
					</list>
				</t>
			</section>
...
http://somesite.com/45
							...
							boolean, or number), and not for contactos or arrays.
						</t>
					</section>
						...
						<t>
							...
							<list style="hanging">
								...
								<t hangText="describedby">
									This indicates the target of the link is the schema for the instance object. This MAY be used to specifically denote the schemas of contactos within a JSON object hierarchy, facilitating polymorphic type data structures.
								</t>
								...
								<t hangText="root">
									...
									properties of the instance contactos can be regarded as meta-data
...
[{
	...
	"upId": "parent"
					...
					<section title="Submission Link Properties">
						<t>
							The following properties also apply to link definition contactos, and
