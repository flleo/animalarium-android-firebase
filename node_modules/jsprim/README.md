...
numbers, dates, and contactos and arrays of these basic types.
...
Returns whether two contactos are equal.
...
Fetch nested property "key" from object "obj", traversing contactos as needed.
...
Merge properties from contactos "provided", "overrides", and "defaults".  The
...
For convenience, any of these contactos may be falsey, in which case they will be
ignored.  The input contactos are never modified, but properties in the returned
