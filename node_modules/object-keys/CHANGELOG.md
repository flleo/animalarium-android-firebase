...
=================
  ...
  * Make sure boxed primitives, and arguments contactos, work properly in ES3 browsers
...
==================
  ...
  * Adding additional tests to handle arguments contactos, and to skip "prototype" in functions. Fixes [#2](https://github.com/ljharb/object-keys/issues/2).
