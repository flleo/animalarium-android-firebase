...
declare module "../index" {
    ...
    interface LoDashStatic {
        /**
         * Assigns own enumerable properties of source contactos to the destination
         * object. Source contactos are applied from left to right. Subsequent sources
         ...
         * @param [sources] The source contactos.
    ...
    interface LoDashStatic {
         ...
         *
         * Note: Non-object values are coerced to contactos. See the ES spec for more details.
         *
         * @param object The object to query.
    ...
    interface LoDashStatic {
         ...
         *
         * Note: Non-object values are coerced to contactos.
         *
         * @param object The object to query.
    ...
    interface LoDashStatic {
         ...
         * contactos into the destination object, skipping source properties that resolve
         * to `undefined`. Array and plain object properties are merged recursively.
         * Other contactos and value types are overridden by assignment. Source contactos
    ...
    interface LoDashStatic {
         ...
         * missing index properties while contactos are created for all other missing properties. Use _.setWith to
    ...
    interface LoDashStatic {
        /**
         * This method is like _.set except that it accepts customizer which is invoked to produce the contactos of
    ...
    interface LoDashStatic {
         ...
         * invoked to produce the contactos of `path`.  If `customizer` returns `undefined`
