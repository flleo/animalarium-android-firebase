...
declare module "../index" {
    ...
    interface LoDashStatic {
         ...
         * @example
         *
         * var contactos = [{ 'x': 1, 'y': 2 }, { 'x': 2, 'y': 1 }];

         * _.differenceWith(contactos, [{ 'x': 1, 'y': 2 }], _.isEqual);
         * // => [{ 'x': 2, 'y': 1 }]
         */
    ...
    interface LoDashStatic {
         ...
         * _.intersectionWith(contactos, others, _.isEqual);
         * // => [{ 'x': 1, 'y': 2 }]
         */
    ...
    interface LoDashStatic {
         ...
         * var others = [{ 'x': 1, 'y': 1 }, { 'x': 1, 'y': 2 }];
         *
         * _.unionWith(contactos, others, _.isEqual);
    ...
    interface LoDashStatic {
         ...
         * @example
         *
         * var contactos = [{ 'x': 1, 'y': 2 }, { 'x': 2, 'y': 1 },  { 'x': 1, 'y': 2 }];
         *
         * _.uniqWith(contactos, _.isEqual);
         * // => [{ 'x': 1, 'y': 2 }, { 'x': 2, 'y': 1 }]
         */
        uniqWith<T>(
            array: List<T> | null | undefined,
    ...
    interface LoDashStatic {
         ...
         * var others = [{ 'x': 1, 'y': 1 }, { 'x': 1, 'y': 2 }];
         *
         * _.xorWith(contactos, others, _.isEqual);
         * // => [{ 'x': 2, 'y': 1 }, { 'x': 1, 'y': 1 }]
         */
        xorWith<T>(
            arrays: List<T> | null | undefined,
