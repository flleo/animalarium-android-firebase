...
declare module "../index" {
    ...
    interface LoDashStatic {
         ...
         * array buffers, booleans, date contactos, maps, numbers, Object contactos, regexes, sets, strings, symbols,
         * and typed arrays. The own enumerable properties of arguments contactos are cloned as plain contactos. An empty
         * object is returned for uncloneable values such as error contactos, functions, DOM nodes, and WeakMaps.
         *
    ...
    interface LoDashStatic {
         ...
         * date contactos, error contactos, maps, numbers, `Object` contactos, regexes,
         * sets, strings, symbols, and typed arrays. `Object` contactos are compared
    ...
    interface LoDashStatic {
        /**
         * Checks if value is the language type of Object. (e.g. arrays, functions, contactos, regexes, new Number(0),
         * and new String(''))
         *
         * @param value The value to check.
    ...
    interface LoDashStatic {
         ...
         * [[Prototype]] of null.
         *
         * Note: This method assumes contactos created by the Object constructor have no inherited enumerable properties.
         *
         * @param value The value to check.
