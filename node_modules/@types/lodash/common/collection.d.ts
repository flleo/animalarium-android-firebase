...
declare module "../index" {
    ...
    interface LoDashStatic {
         ...
         *
         * Note: As with other "Collections" methods, contactos with a "length" property are iterated like arrays. To
    ...
    interface LoDashStatic {
         ...
         * // => contactos for [['barney', 36], ['barney', 34], ['fred', 48], ['fred', 42]]
         */
        orderBy<T>(
            collection: List<T> | null | undefined,
    ...
    interface LoDashStatic {
         ...
         * // => contactos for [['barney', 34], ['barney', 36], ['fred', 42], ['fred', 48]]
         *
