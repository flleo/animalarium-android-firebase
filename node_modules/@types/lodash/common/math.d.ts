...
declare module "../index" {
    ...
    interface LoDashStatic {
         ...
         * @example
         *
         * var contactos = [{ 'n': 1 }, { 'n': 2 }];
         *
         * _.maxBy(contactos, function(o) { return o.a; });
         * // => { 'n': 2 }
         *
    ...
    interface LoDashStatic {
      /**
       * Computes the mean of the provided propties of the contactos in the `array`
       *
       * @category Math
       * @param array The array to iterate over.
       * @param iteratee The iteratee invoked per element.
    ...
    interface LoDashStatic {
         ...
         * var contactos = [{ 'n': 1 }, { 'n': 2 }];
         *
         * _.minBy(contactos, function(o) { return o.a; });
         * // => { 'n': 1 }
         *
         * // using the `_.property` iteratee shorthand
         * _.minBy(contactos, 'n');
    ...
    interface LoDashStatic {
         ...
         * @example
         *
         * var contactos = [{ 'n': 4 }, { 'n': 2 }, { 'n': 8 }, { 'n': 6 }];
         *
         * _.sumBy(contactos, function(o) { return o.n; });
         * // => 20
         *
         * // using the `_.property` iteratee shorthand
         * _.sumBy(contactos, 'n');
