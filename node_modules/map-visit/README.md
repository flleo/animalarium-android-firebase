...
> Map `visit` over an array of contactos.
...
* extend contactos onto the `data` object
* extend arrays of contactos onto the data object
...
* [collection-visit](https://www.npmjs.com/package/collection-visit): Visit a method over the items in an object, or map visit over the contactos… [more](https://github.com/jonschlinkert/collection-visit) | [homepage](https://github.com/jonschlinkert/collection-visit "Visit a method over the items in an object, or map visit over the contactos in an array.")
