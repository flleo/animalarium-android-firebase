...
- `Object.assign` should be defined in the strict mode -> throw an error on extension non-extensible contactos, [#154](https://github.com/zloirock/core-js/issues/154)
...
##### 0.4.7 - 2015.01.25
* Added support frozen contactos as [collections](https://github.com/zloirock/core-js/#ecmascript-6-collections) keys
